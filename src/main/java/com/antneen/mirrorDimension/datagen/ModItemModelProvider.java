...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.KYRIUM_HELMET);
        trimmedArmorItem(ModItems.KYRIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.KYRIUM_LEGGINGS);
        trimmedArmorItem(ModItems.KYRIUM_BOOTS);
    }

    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Mirror_Dimension.MODID; // Change this to your mod id
